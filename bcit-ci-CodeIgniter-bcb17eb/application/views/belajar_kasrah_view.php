...
<html>
<head>
    <title>Huruf Hijaiyah Kasrah</title>
    ...
    <style>
        ...
        @media (max-width: 600px) { .huruf-tab-btn { font-size: 0.97em; padding: 8px 10px; } .huruf-menu-bar { gap: 7px; } .huruf-menu-btn { font-size: 0.97em; padding: 8px 10px; } }
    </style>
</head>
<body>
    <div class="navbar">
    ...
    <div class="container">
        <div class="huruf-header">Huruf Hijaiyah dengan Kasrah</div>
        ...
        <div class="huruf-menu-bar">
            ...
            <a class="huruf-menu-btn active" href="<?php echo site_url('dashboard/kasrah'); ?>">Kasrah</a>
            <a class="huruf-menu-btn" href="<?php echo site_url('dashboard/dhammah'); ?>">Dhammah</a>
        ...
        <div class="huruf-grid">
            ...
            foreach($huruf as $i=>$h) {
                $color = $colors[$i%6];
                echo "<div class='huruf-card $color' onclick=\"showKasrahModal({$i})\">\n
